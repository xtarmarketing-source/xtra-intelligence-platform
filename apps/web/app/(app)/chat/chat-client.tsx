...
export function ChatClient({
  ...
  return (
    <div className="flex-1 flex border border-line rounded-2xl overflow-hidden bg-white shadow-sm min-h-0">
      <div
        className={`w-full sm:w-56 flex-none border-r border-line overflow-y-auto ${
      ...
      <div className={`flex-1 flex-col min-h-0 ${selected ? "flex" : "hidden sm:flex"}`}>
        {selected ? (
          <>
            <div className="border-b border-line px-4 py-3 flex items-center gap-2">
              <button
                ...
                className="sm:hidden p-1 -ml-1 rounded-lg hover:bg-line-soft"
              >
